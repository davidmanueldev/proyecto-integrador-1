...
const TransactionTable = ({ transactions }) => {
  ...
  const filteredAndSortedTransactions = useMemo(() => {
    ...
    // Aplicar filtros de frecuencia (recurring filter)
    if (recurringFilter) {
      result = result.filter((transaction) => {
    ...
    // Aplicar filtro de tipo (income/expense)
    if (typeFilter) {
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="recurring">Solo Frecuente</SelectItem>
              <SelectItem value="non-recurring">No Frecuente</SelectItem>
            </SelectContent>
          </Select>
